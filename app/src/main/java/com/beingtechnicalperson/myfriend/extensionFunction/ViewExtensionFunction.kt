...
import com.beingtechnicalperson.myfriend.constant.Constants
import com.beingtechnicalperson.myfriend.listener.HomeListener
...
fun modifyOrientation(bitmap: Bitmap, image_absolute_path: String): Bitmap {
    var ei: ExifInterface = ExifInterface(image_absolute_path)
...
fun getTimeStampConvert(timeStamp: String): String {
    val dateFormat = SimpleDateFormat("hh:mm aa , d MMM yyyy")
    return dateFormat.format(timeStamp.toLong().let { Date(it) })
}
